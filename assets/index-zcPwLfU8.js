...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new U(0,1,0);return new ba({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new ba({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new ba({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Fm.BlurDirectionX=new H(1,0),Fm.BlurDirectionY=new H(0,1);var Im={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
		...
		}`},zm=class{constructor(e,t,n,r={}){let{bloom:i=!0,bloomStrength:a=.5,bloomRadius:o=.1,bloomThreshold:s=.9,vignette:c=!1,vignetteOffset:l=1,vignetteDarkness:u=1.2}=r;this.composer=new Mm(e);let d=new Nm(t,n);this.composer.addPass(d),i&&(this.bloomPass=new Fm(new H(window.innerWidth,window.innerHeight),a,o,s),this.composer.addPass(this.bloomPass)),c&&(this.vignettePass=new km(Rm),this.vignettePass.uniforms.offset.value=l,this.vignettePass.uniforms.darkness.value=u,this.composer.addPass(this.vignettePass));let f=new Lm;this.composer.addPass(f)}setSize(e,t){this.composer.setSize(e,t)}render(e){this.composer.render(e)}},Bm=class{constructor(e,t={}){let{fov:n=60,near:r=.01,far:i=1e3,position:a={x:0,y:15,z:10}}=t;this.camera=new ho(n,window.innerWidth/window.innerHeight,r,i),this.camera.position.set(a.x,a.y,a.z),e.add(this.camera),this.audioListener=new Vo,this.camera.add(this.audioListener),this.offset=new U(10,30,25),this.smoothness=10,this._onResize=this._onResize.bind(this),window.addEventListener(`resize`,this._onResize)}_onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix()}follow(e,t){if(!e||!t)return;let n=new U().addVectors(e,this.offset),r=1-Math.exp(-this.smoothness*t);this.camera.position.lerp(n,r),this.camera.lookAt(e)}},Vm=class{constructor(e){this.bindings=e||{forward:[`KeyW`,`ArrowUp`],backward:[`KeyS`,`ArrowDown`],left:[`KeyA`,`ArrowLeft`],right:[`KeyD`,`ArrowRight`],drift:[`ShiftLeft`,`ShiftRight`],brake:[`Space`],horn:[`KeyH`]},this.state={},this.justPressed={},this.justReleased={};for(let e of Object.keys(this.bindings))this.state[e]=!1,this.justPressed[e]=!1,this.justReleased[e]=!1;this._keyMap=new Map;for(let[e,t]of Object.entries(this.bindings))for(let n of t)this._keyMap.set(n,e);this._callbacks=new Map,this._onKeyDown=this._onKeyDown.bind(this),this._onKeyUp=this._onKeyUp.bind(this),window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp)}_onKeyDown(e){if(e.repeat)return;let t=this._keyMap.get(e.code);t!==void 0&&(this.state[t]||(this.justPressed[t]=!0),this.state[t]=!0,e.preventDefault(),this._callbacks.get(t)?.(!0))}_onKeyUp(e){let t=this._keyMap.get(e.code);t!==void 0&&(this.state[t]&&(this.justReleased[t]=!0),this.state[t]=!1,this._callbacks.get(t)?.(!1))}update(){for(let e of Object.keys(this.bindings))this.justPressed[e]=!1,this.justReleased[e]=!1}isPressed(e){return!!this.state[e]}isJustPressed(e){return!!this.justPressed[e]}isJustReleased(e){return!!this.justReleased[e]}onAction(e,t){this._callbacks.set(e,t)}destroy(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp)}},Hm=class{constructor(e){if(this.listener=e,this.context=e.context,this._sounds=new Map,this._mesh=null,this._loader=new ko,this.context.state===`suspended`){let e=()=>{this.context.resume(),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e),window.addEventListener(`keydown`,e)}}async load(e,t,n={}){let{loop:r=!1,volume:i=1,positional:a=!0,refDistance:o=10,maxDistance:s=50}=n;try{let n=await this._loader.loadAsync(t),c=a?new qo(this.listener):new Ho(this.listener);c.setBuffer(n),c.setLoop(r),c.setVolume(i),a&&(c.setRefDistance(o),c.setMaxDistance(s)),this._sounds.set(e,{audio:c,positional:a,baseVolume:i}),a&&this._mesh&&this._mesh.add(c)}catch(n){console.warn(`[AudioManager] Could not load "${e}" from "${t}":`,n.message)}}attachTo(e){this._mesh=e;for(let t of this._sounds.values())t.positional&&t.audio.parent!==e&&e.add(t.audio)}_get(e){let t=this._sounds.get(e);return t||console.warn(`[AudioManager] "${e}" isn't loaded yet (or failed to load) — ignoring.`),t}play(e){let t=this._get(e);t&&(t.audio.isPlaying||t.audio.play())}stop(e){let t=this._get(e);!t||!t.audio.isPlaying||t.audio.stop()}playOneShot(e,t={}){let n=this._get(e);if(!n)return;let{volume:r,cooldown:i=0}=t;if(i>0){let e=performance.now();if(n._lastPlayed&&e-n._lastPlayed<i)return;n._lastPlayed=e}n.audio.isPlaying&&n.audio.stop(),r!==void 0&&(n.audio.setVolume(r),n.audio.onEnded=()=>{n.audio.setVolume(n.baseVolume),n.audio.onEnded=null}),n.audio.play()}playMusic(e){this.play(e)}stopMusic(e){this.stop(e)}setVolume(e,t){let n=this._sounds.get(e);n&&n.audio.setVolume(t)}setRate(e,t){let n=this._sounds.get(e);!n||!n.audio.isPlaying||n.audio.setPlaybackRate(t)}fadeTo(e,t,n,r=4){let i=this._sounds.get(e);if(!i)return;let a=i.audio.getVolume(),o=a+(t-a)*n*r;i.audio.setVolume(o)}isPlaying(e){let t=this._sounds.get(e);return t?t.audio.isPlaying:!1}},Um=class{constructor(e={}){let{gravity:t={x:0,y:-9.82,z:0},allowSleep:n=!1,fixedStep:r=1/60,maxSubSteps:i=3}=e;this._fixedStep=r,this._maxSubSteps=i,this.world=new om,this.world.gravity.set(t.x,t.y,t.z),this.world.allowSleep=n,this.activeOverlaps=new Set}setupGround(e,t,n){let r=new ua(e,e),i=new Sa({color:t,roughness:.8,metalness:.2});this.groundMesh=new ni(r,i),this.groundMesh.rotation.x=-Math.PI/2,this.groundMesh.receiveShadow=!0,n.add(this.groundMesh),this.groundMaterial=new kf(`ground`);let a=e/2,o=new Q({mass:0,shape:new Zu(new X(a,.5,a)),material:this.groundMaterial});o.position.set(0,-.5,0),this.world.addBody(o)}addBody(e,t=null){t&&(e.userData={entity:t},e.addEventListener(`collide`,e=>{let n=e.body.userData?.entity;t.onCollision&&t.onCollision(n,e)})),this.world.addBody(e)}removeBody(e){this.world.removeBody(e)}checkTriggers(){let e=new Set,t=this.world.contacts||[];for(let n=0;n<t.length;n++){let r=t[n],i=r.bi,a=r.bj;if(i.isTrigger||a.isTrigger){let t=i.isTrigger?i:a,n=i.isTrigger?a:i,r=t.userData?.entity,o=n.userData?.entity,s=`${t.id}-${n.id}`;e.add(s),this.activeOverlaps.has(s)||(this.activeOverlaps.add(s),r?.onTriggerEnter?.(o))}}for(let t of this.activeOverlaps)if(!e.has(t)){this.activeOverlaps.delete(t);let[e,n]=t.split(`-`).map(Number),r=this.world.bodies.find(t=>t.id===e),i=this.world.bodies.find(e=>e.id===n),a=r?.userData?.entity,o=i?.userData?.entity;a?.onTriggerExit?.(o)}}step(e){this.world.step(this._fixedStep,e,this._maxSubSteps),this.checkTriggers()}},Wm=class{constructor(e,t={}){let{ambientColor:n=16777215,ambientIntensity:r=1.3,sunColor:i=16777215,sunIntensity:a=1.5,sunPosition:o={x:35,y:45,z:25},shadows:s=!0,shadowMapSize:c=4096,shadowArea:l=35,fillColor:u=9684477,fillIntensity:d=.7,fillPosition:f={x:-30,y:20,z:-30}}=t;this.ambient=new Co(n,r),e.add(this.ambient),this.sun=new So(i,a),this.sun.position.set(o.x,o.y,o.z),this.sun.castShadow=s,s&&(this.sun.shadow.mapSize.width=c,this.sun.shadow.mapSize.height=c,this.sun.shadow.camera.near=.5,this.sun.shadow.camera.far=150,this.sun.shadow.camera.left=-l,this.sun.shadow.camera.right=l,this.sun.shadow.camera.top=l,this.sun.shadow.camera.bottom=-l,this.sun.shadow.bias=-4e-4),e.add(this.sun),this.fill=new So(u,d),this.fill.position.set(f.x,f.y,f.z),e.add(this.fill)}moveSun(e,t,n=1){this.sun.position.lerp(new U(e.x,e.y,e.z),t*n)}setSunIntensity(e){this.sun.intensity=e}setAmbientIntensity(e){this.ambient.intensity=e}},Gm={type:`change`},Km={type:`start`},qm={type:`end`},Jm=new Ur,Ym=new Mi,Xm=Math.cos(70*At.DEG2RAD),Zm=new U,Qm=2*Math.PI,$m={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},eh=1e-6,th=class extends ds{constructor(n,r=null){super(n,r),this.state=$m.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new jt,this._lastTargetPosition=new U,this._quat=new jt().setFromUnitVectors(n.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new us,this._sphericalDelta=new us,this._scale=1,this._panOffset=new U,this._rotateStart=new H,this._rotateEnd=new H,this._rotateDelta=new H,this._panStart=new H,this._panEnd=new H,this._panDelta=new H,this._dollyStart=new H,this._dollyEnd=new H,this._dollyDelta=new H,this._dollyDirection=new U,this._mouse=new H,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=rh.bind(this),this._onPointerDown=nh.bind(this),this._onPointerUp=ih.bind(this),this._onContextMenu=dh.bind(this),this._onMouseWheel=sh.bind(this),this._onKeyDown=ch.bind(this),this._onTouchStart=lh.bind(this),this._onTouchMove=uh.bind(this),this._onMouseDown=ah.bind(this),this._onMouseMove=oh.bind(this),this._interceptControlDown=fh.bind(this),this._interceptControlUp=ph.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Gm),this.update(),this.state=$m.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Zm.copy(t).sub(this.target),Zm.applyQuaternion(this._quat),this._spherical.setFromVector3(Zm),this.autoRotate&&this.state===$m.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Qm:n>Math.PI&&(n-=Qm),r<-Math.PI?r+=Qm:r>Math.PI&&(r-=Qm),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Zm.setFromSpherical(this._spherical),Zm.applyQuaternion(this._quatInverse),t.copy(this.target).add(Zm),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Zm.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new U(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new U(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Zm.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Jm.origin.copy(this.object.position),Jm.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Jm.direction))<Xm?this.object.lookAt(this.target):(Ym.setFromNormalAndCoplanarPoint(this.object.up,this.target),Jm.intersectPlane(Ym,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>eh||8*(1-this._lastQuaternion.dot(this.object.quaternion))>eh||this._lastTargetPosition.distanceToSquared(this.target)>eh?(this.dispatchEvent(Gm),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?Qm/60/60*this.autoRotateSpeed:Qm/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Zm.setFromMatrixColumn(t,0),Zm.multiplyScalar(-e),this._panOffset.add(Zm)}_panUp(e,t){this.screenSpacePanning===!0?Zm.setFromMatrixColumn(t,1):(Zm.setFromMatrixColumn(t,0),Zm.crossVectors(this.object.up,Zm)),Zm.multiplyScalar(e),this._panOffset.add(Zm)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Zm.copy(r).sub(this.target);let i=Zm.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Qm*this._rotateDelta.x/t.clientHeight),this._rotateUp(Qm*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Qm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Qm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Qm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Qm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Qm*this._rotateDelta.x/t.clientHeight),this._rotateUp(Qm*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new H,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function nh(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function rh(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function ih(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(qm),this.state=$m.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function ah(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=$m.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$m.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$m.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$m.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$m.PAN}break;default:this.state=$m.NONE}this.state!==$m.NONE&&this.dispatchEvent(Km)}function oh(e){switch(this.state){case $m.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case $m.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case $m.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function sh(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===$m.NONE&&(e.preventDefault(),this.dispatchEvent(Km),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(qm))}function ch(e){this.enabled!==!1&&this._handleKeyDown(e)}function lh(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=$m.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=$m.TOUCH_PAN;break;default:this.state=$m.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=$m.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=$m.TOUCH_DOLLY_ROTATE;break;default:this.state=$m.NONE}break;default:this.state=$m.NONE}this.state!==$m.NONE&&this.dispatchEvent(Km)}function uh(e){switch(this._trackPointer(e),this.state){case $m.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case $m.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case $m.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case $m.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=$m.NONE}}function dh(e){this.enabled!==!1&&e.preventDefault()}function fh(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function ph(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var mh=function(){var e=0,t=document.createElement(`div`);t.style.cssText=`position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000`,t.addEventListener(`click`,function(n){n.preventDefault(),r(++e%t.children.length)},!1);function n(e){return t.appendChild(e.dom),e}function r(n){for(var r=0;r<t.children.length;r++)t.children[r].style.display=r===n?`block`:`none`;e=n}var i=(performance||Date).now(),a=i,o=0,s=n(new mh.Panel(`FPS`,`#0ff`,`#002`)),c=n(new mh.Panel(`MS`,`#0f0`,`#020`));if(self.performance&&self.performance.memory)var l=n(new mh.Panel(`MB`,`#f08`,`#201`));return r(0),{REVISION:16,dom:t,addPanel:n,showPanel:r,begin:function(){i=(performance||Date).now()},end:function(){o++;var e=(performance||Date).now();if(c.update(e-i,200),e>=a+1e3&&(s.update(o*1e3/(e-a),100),a=e,o=0,l)){var t=performance.memory;l.update(t.usedJSHeapSize/1048576,t.jsHeapSizeLimit/1048576)}return e},update:function(){i=this.end()},domElement:t,setMode:r}};mh.Panel=function(e,t,n){var r=1/0,i=0,a=Math.round,o=a(window.devicePixelRatio||1),s=80*o,c=48*o,l=3*o,u=2*o,d=3*o,f=15*o,p=74*o,m=30*o,h=document.createElement(`canvas`);h.width=s,h.height=c,h.style.cssText=`width:80px;height:48px`;var g=h.getContext(`2d`);return g.font=`bold `+9*o+`px Helvetica,Arial,sans-serif`,g.textBaseline=`top`,g.fillStyle=n,g.fillRect(0,0,s,c),g.fillStyle=t,g.fillText(e,l,u),g.fillRect(d,f,p,m),g.fillStyle=n,g.globalAlpha=.9,g.fillRect(d,f,p,m),{dom:h,update:function(c,_){r=Math.min(r,c),i=Math.max(i,c),g.fillStyle=n,g.globalAlpha=1,g.fillRect(0,0,s,f),g.fillStyle=t,g.fillText(a(c)+` `+e+` (`+a(r)+`-`+a(i)+`)`,l,u),g.drawImage(h,d+o,f,p-o,m,d,f,p-o,m),g.fillRect(d+p-o,f,o,m),g.fillStyle=n,g.globalAlpha=.9,g.fillRect(d+p-o,f,o,a((1-c/_)*m))}}};var hh=class{constructor(e={}){let{backgroundColor:t=Cm.background,fogDensity:n=.01,ground:r=!0,groundSize:i=300,groundColor:a=Cm.ground,lightingOptions:o={},bloom:s=!0,bloomStrength:c=.12,bloomRadius:l=.2,bloomThreshold:u=.85,orbitControls:d=!1,inputBindings:f,debug:p=!1}=e;this.scene=new In,this.scene.background=new q(t),this.scene.fog=new Fn(t,n),this.camera=new Bm(this.scene),this.audioListener=this.camera.audioListener,this.renderer=new ku({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.1,document.body.appendChild(this.renderer.domElement),d&&(this.controls=new th(this.camera.camera,this.renderer.domElement),this.controls.target.set(0,0,0)),this.postProcessing=new zm(this.renderer,this.scene,this.camera.camera,{bloom:s,bloomStrength:c,bloomRadius:l,bloomThreshold:u}),this.lighting=new Wm(this.scene,o),this.physics=new Um,r&&this.physics.setupGround(i,a,this.scene),this.audio=new Hm(this.audioListener),this.input=new Vm(f),this.entities=[],this._setupRaycaster(),this.stats=new mh,this.stats.showPanel(0),document.body.appendChild(this.stats.dom),this.stats.dom.style.position=`absolute`,this.stats.dom.style.left=`0px`,this.stats.dom.style.top=`0px`}addEntity(e){this.entities.includes(e)||this.entities.push(e)}_setupRaycaster(){this.raycaster=new ss,this.mouse=new H,window.addEventListener(`pointerdown`,e=>{this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera.camera);let t=this.raycaster.intersectObjects(this.scene.children,!0);if(t.length>0){let e=t[0].object;for(;e&&!e.userData?.entity;)e=e.parent;e?.userData?.entity&&e.userData.entity.onMouseClick?.(t[0])}})}update(e){this.physics.step(e);for(let t=this.entities.length-1;t>=0;t--){let n=this.entities[t];n&&!n.isDestroyed&&n.update(e)}this.renderer.render(this.scene,this.camera.camera),this.input.update(),this.stats.update()}},gh=class{constructor(e){this.world=e,this.mesh=new Dn,this.body=null,this.isDestroyed=!1,this.mesh.userData.entity=this,this.world.addEntity(this),this.world.scene.add(this.mesh)}setPhysicsBody(e){this.body=e,this.world.physics.addBody(this.body,this)}onCollision(e,t){}onTriggerEnter(e){}onTriggerExit(e){}onMouseClick(e){}update(e){this.isDestroyed||this.body&&(this.mesh.position.copy(this.body.position),this.mesh.quaternion.copy(this.body.quaternion))}destroy(){if(this.isDestroyed)return;this.isDestroyed=!0,this.body&&=(this.world.physics.removeBody(this.body),null),this.world.scene.remove(this.mesh),this.mesh.traverse(e=>{e.isMesh&&(e.geometry?.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material?.dispose())});let e=this.world.entities.indexOf(this);e!==-1&&this.world.entities.splice(e,1)}},_h=class extends gh{constructor(e,t={x:0,y:0,z:0}){super(e);let n={x:3,y:3,z:3},r=new ca(n.x,n.y,n.z);this.material=new Sa({color:Cm.obstacle,roughness:.3});let i=new ni(r,this.material);i.castShadow=!0,i.receiveShadow=!0,this.mesh.add(i);let a=new Zu(new X(n.x/2,n.y/2,n.z/2)),o=new Q({mass:2,position:new X(t.x,t.y,t.z),shape:a,linearDamping:.5});this.setPhysicsBody(o)}onCollision(e,t){if(e&&e.constructor.name===`KartPlayer`){let t=new X(this.body.position.x-e.body.position.x,2,this.body.position.z-e.body.position.z);t.normalize(),t.scale(5,t),this.body.applyImpulse(t)}}onMouseClick(e){--this.health,this.material.color.setHex(16746496),setTimeout(()=>{this.material.color.setHex(16777215)},100),this.body.applyImpulse(new X(0,20,0)),this.health<=0&&this.destroy()}update(e){super.update(e),this.isDestroyed}};function vh(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function yh(e){let t=new Map,n=new Map,r=e.clone();return bh(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function bh(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)bh(e.children[r],t.children[r],n)}var xh=class extends Ya{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Dh(e)}),this.register(function(e){return new Oh(e)}),this.register(function(e){return new Lh(e)}),this.register(function(e){return new Rh(e)}),this.register(function(e){return new zh(e)}),this.register(function(e){return new Ah(e)}),this.register(function(e){return new jh(e)}),this.register(function(e){return new Mh(e)}),this.register(function(e){return new Nh(e)}),this.register(function(e){return new Eh(e)}),this.register(function(e){return new Ph(e)}),this.register(function(e){return new kh(e)}),this.register(function(e){return new Ih(e)}),this.register(function(e){return new Fh(e)}),this.register(function(e){return new wh(e)}),this.register(function(e){return new Bh(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Bh(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Vh(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=wo.extractUrlBase(e);a=wo.resolveURL(t,this.path)}else a=wo.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new Qa(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Hh){try{a[$.KHR_BINARY_GLTF]=new Gh(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new _g(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new Th;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new Kh(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new qh;break;case $.KHR_MESH_QUANTIZATION:a[t]=new Jh;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Sh(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Ch(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},wh=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new q(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],He);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new So(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new yo(s),o.distance=c;break;case`spot`:o=new _o(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),lg(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},Th=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return Wr}extendParams(e,t,n){let r=[];e.color=new q(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],He),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Ve))}return Promise.all(r)}},Eh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Dh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new H(e,e)}return Promise.all(r)}},Oh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},kh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Ah=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new q(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],He)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Ve)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},jh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},Mh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new q().setRGB(i[0],i[1],i[2],He),Promise.all(r)}},Nh=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Ph=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new q().setRGB(i[0],i[1],i[2],He),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Ve)),Promise.all(r)}},Fh=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Ih=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Ch(this.parser,e,this.name)===null?null:Ca}extendMaterialParams(e,t){let n=Ch(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Lh=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Rh=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},zh=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Bh=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}return null}},Vh=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Qh.TRIANGLES&&e.mode!==Qh.TRIANGLE_STRIP&&e.mode!==Qh.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new K,n=new U,a=new jt,s=new U(1,1,1),c=new Oi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new bi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);En.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Hh=`glTF`,Uh=12,Wh={JSON:1313821514,BIN:5130562},Gh=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Uh),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Hh)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Uh,i=new DataView(e,Uh),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Wh.JSON){let r=new Uint8Array(e,Uh+a,t);this.content=n.decode(r)}else if(r===Wh.BIN){let n=Uh+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Kh=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=rg[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=rg[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=$h[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,He,n)})})}},qh=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Jh=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},Yh=class extends Aa{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},Xh=new jt,Zh=class extends Yh{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return Xh.fromArray(i).normalize().toArray(i),i}},Qh={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},$h={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},eg={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},tg={33071:i,33648:a,10497:r},ng={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},rg={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},ig={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},ag={CUBICSPLINE:void 0,LINEAR:Ie,STEP:F},og={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function sg(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Sa({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function cg(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function lg(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function ug(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function dg(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function fg(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+pg(n.attributes):e.indices+`:`+pg(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+pg(e.targets[n]);return t}function pg(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function mg(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function hg(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var gg=new K,_g=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Sh,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}this.textureLoader=typeof createImageBitmap>`u`||n&&r<17||i&&a<98?new to(this.options.manager):new Eo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Qa(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return cg(i,a,r),lg(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e)}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(wo.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=ng[r.type],t=$h[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new hr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=ng[r.type],o=$h[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new jr(f,u/s),t.cache.add(n,c)),p=new Nr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new hr(f,a,d);if(r.sparse!==void 0){let t=ng.SCALAR,n=$h[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new hr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=eg[n.magFilter]||1006,t.minFilter=eg[n.minFilter]||1008,t.wrapS=tg[n.wrapS]||1e3,t.wrapT=tg[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new qt(e);t.needsUpdate=!0,n(t)}),t.load(wo.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),lg(e,a),e.userData.mimeType=a.mimeType||hg(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Zi,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Li,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Sa}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new q(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],He),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Ve)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||og.OPAQUE;if(l===og.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===og.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new H(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Wr){let e=i.emissiveFactor;o.emissive=new q().setRGB(e[0],e[1],e[2],He)}return i.emissiveTexture!==void 0&&a!==Wr&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Ve)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),lg(n,i),t.associations.set(n,{materials:e}),i.extensions&&cg(r,n,i),n})}createUniqueName(e){let t=as.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return yg(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=fg(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):yg(new Ar,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?sg(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Qh.TRIANGLES||u.mode===Qh.TRIANGLE_STRIP||u.mode===Qh.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new mi(l,f):new ni(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Qh.TRIANGLE_STRIP?d.geometry=vh(d.geometry,1):u.mode===Qh.TRIANGLE_FAN&&(d.geometry=vh(d.geometry,2));else if(u.mode===Qh.LINES)d=new Yi(l,f);else if(u.mode===Qh.LINE_STRIP)d=new Gi(l,f);else if(u.mode===Qh.LINE_LOOP)d=new Xi(l,f);else if(u.mode===Qh.POINTS)d=new na(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&dg(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),lg(d,i),u.extensions&&cg(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&cg(r,c[0],i),c[0];let l=new Dn;i.extensions&&cg(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new ho(At.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new bo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),lg(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new K;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new yi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new Ua(i,void 0,l);return lg(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,gg)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new U().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new hi:t.length>1?new Dn:t.length===1?t[0]:new En,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),lg(o,i),i.extensions&&cg(n,o,i),i.matrix!==void 0){let e=new K;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Dn;n.name&&(i.name=r.createUniqueName(n.name)),lg(i,n),n.extensions&&cg(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(yh(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Fr||e instanceof qt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}ig[i.path]===ig.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(ig[i.path]){case ig.weights:l=Ra;break;case ig.rotation:l=Ba;break;case ig.translation:case ig.scale:l=Ha;break;default:switch(n.itemSize){case 1:l=Ra;break;default:l=Ha}}let u=r.interpolation===void 0?Ie:ag[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+ig[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=mg(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Ba?Zh:Yh)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function vg(e,t,n){let r=t.attributes,i=new Zn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new U(t[0],t[1],t[2]),new U(a[0],a[1],a[2])),e.normalized){let t=mg($h[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new U,t=new U;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=mg($h[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Sr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function yg(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=rg[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return G.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${G.workingColorSpace}" not supported.`),lg(e,t),vg(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:ug(e,t.targets,n)})}var bg=new xh,xg=new Map;function Sg(e){return xg.has(e)||xg.set(e,new Promise((t,n)=>{bg.load(e,e=>t(e.scene),void 0,n)})),xg.get(e)}var Cg=class extends gh{constructor(e,t={x:0,y:2,z:0}){super(e),this.name,this.maxSpeed=26,this.reverseMaxSpeed=10,this.acceleration=36,this.deceleration=22,this.braking=55,this.steerSpeed=3.2,this.steerResponse=10,this.maxSteerAngle=.5,this.isDriftingState=!1,this.wasDriftPressed=!1,this.driftDirection=0,this.driftAngle=0,this.maxDriftAngle=.1,this.normalGrip=.94,this.driftGrip=.14,this.currentGrip=this.normalGrip,this.currentTurnRate=0,this.turnRateResponse=6,this.maxRoll=.2,this.maxPitch=.14,this.tiltLeanSpeed=8,this.currentSpeed=0,this.currentSteer=0,this.yaw=0,this.engineRPM=.25,this.targetRPM=.25,this.numGears=4,this._setupVisualMesh(),this._setupPhysicsBody(t),this._setupAudio()}_setupVisualMesh(){this.chassisTiltGroup=new Dn,this.mesh.add(this.chassisTiltGroup);let e=new ca(1.4,.6,2.8),t=new Sa({color:15606323,roughness:.3,metalness:.2});this.chassisMesh=new ni(e,t),this.chassisMesh.position.set(0,.3,0),this.chassisMesh.castShadow=!0,this.chassisMesh.receiveShadow=!0,this.chassisTiltGroup.add(this.chassisMesh),Sg(`/modles/body.glb`).then(e=>{if(this.isDestroyed)return;let t=e.clone(!0);t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),this.chassisTiltGroup.remove(this.chassisMesh),this.chassisTiltGroup.add(t),this.chassisMesh=t}).catch(e=>{console.warn(`[KartPlayer] Could not load body.glb, keeping placeholder box:`,e.message)}),this.wheelRadius=.4;let n=new la(this.wheelRadius,this.wheelRadius,.4,24);n.rotateZ(Math.PI/2);let r=new Sa({color:1118481,roughness:.8}),i=[[-1.5,.3,1.8],[1.5,.3,1.8],[-1.5,.3,-1.5],[1.5,.3,-1.5]];this.wheelPivots=[],this.wheelSpinners=[],i.forEach(e=>{let t=new Dn;t.position.set(...e),this.mesh.add(t);let i=new ni(n,r);i.castShadow=!0,t.add(i),this.wheelPivots.push(t),this.wheelSpinners.push(i)}),Sg(`/modles/wheel.glb`).then(e=>{this.isDestroyed||this.wheelPivots.forEach((t,n)=>{let r=e.clone(!0);r.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),t.remove(this.wheelSpinners[n]),t.add(r),this.wheelSpinners[n]=r})}).catch(e=>{console.warn(`[KartPlayer] Could not load wheel.glb, keeping placeholder cylinders:`,e.message)})}_setupPhysicsBody(e){let t=new kf({friction:0,restitution:0}),n=new Q({mass:120,position:new X(e.x,e.y,e.z),material:t,linearDamping:.08,angularDamping:.95}),r=new Af(.5);n.addShape(r,new X(0,0,0));let i=new Zu(new X(2,1,2.8));n.addShape(i,new X(0,1.2,.2)),n.angularFactor.set(0,1,0),this.body=n,this.setPhysicsBody(n);let a=new jt(this.body.quaternion.x,this.body.quaternion.y,this.body.quaternion.z,this.body.quaternion.w);this.yaw=new ln().setFromQuaternion(a,`YXZ`).y}async _setupAudio(){let e=this.world.audio;e&&(await e.load(`engine-loop`,`/sounds/engine-loop.mp3`,{loop:!0,volume:0,positional:!0,refDistance:8,maxDistance:60}),e.attachTo(this.mesh),e.play(`engine-loop`),e.load(`skid`,`/sounds/skid.mp3`,{loop:!0,volume:.6,positional:!0,refDistance:6,maxDistance:40}),e.load(`beep`,`/sounds/beep.mp3`,{loop:!1,volume:.8,positional:!0,refDistance:10,maxDistance:60}),e.load(`hit`,`/sounds/hit.ogg`,{loop:!1,volume:.9,positional:!0,refDistance:10,maxDistance:60}))}update(e){if(super.update(e),this.isDestroyed||!this.body||e<=0)return;let t=this.world.input;if(!t)return;let n=t.isPressed(`forward`),r=t.isPressed(`backward`),i=t.isPressed(`left`),a=t.isPressed(`right`),o=t.isPressed(`drift`)||t.isPressed(`handbrake`),s=t.isPressed(`brake`);t.isJustPressed(`horn`)&&this.world.audio&&this.world.audio.playOneShot(`beep`,{cooldown:250});let c=Math.abs(this.currentSpeed)/this.maxSpeed,l=1-c*.3;n?this.currentSpeed+=this.acceleration*l*e:r?this.currentSpeed-=this.acceleration*.6*e:this.currentSpeed>0?this.currentSpeed=Math.max(0,this.currentSpeed-this.deceleration*e):this.currentSpeed<0&&(this.currentSpeed=Math.min(0,this.currentSpeed+this.deceleration*e)),s&&(this.currentSpeed>0?this.currentSpeed=Math.max(0,this.currentSpeed-this.braking*e):this.currentSpeed<0&&(this.currentSpeed=Math.min(0,this.currentSpeed+this.braking*e))),this.currentSpeed=At.clamp(this.currentSpeed,-this.reverseMaxSpeed,this.maxSpeed),!n&&!r&&Math.abs(this.currentSpeed)<.1&&(this.currentSpeed=0);let u=0;i&&(u=1),a&&(u=-1),this.currentSteer=At.damp(this.currentSteer,u,this.steerResponse,e);let d=c>.25&&n;o&&!this.wasDriftPressed&&d?Math.abs(this.currentSteer)>.1&&(this.isDriftingState=!0,this.driftDirection=Math.sign(this.currentSteer)):(!o||c<.05)&&(this.isDriftingState=!1,this.driftDirection=0),this.wasDriftPressed=o;let f=0,p=0;if(c>.01){let e=this.currentSpeed>=0?1:-1;if(this.isDriftingState){let e=1+this.currentSteer*this.driftDirection*.6;f=this.driftDirection*this.steerSpeed*1.35*e;let t=1+this.currentSteer*this.driftDirection*.4;p=this.driftDirection*this.maxDriftAngle*t}else f=this.currentSteer*this.steerSpeed*c*e,p=0}this.currentTurnRate=At.damp(this.currentTurnRate,f,this.turnRateResponse,e),this.body.angularVelocity.y=this.currentTurnRate,this.driftAngle=At.damp(this.driftAngle,p,10,e);let m=new jt(this.body.quaternion.x,this.body.quaternion.y,this.body.quaternion.z,this.body.quaternion.w);this.yaw=new ln(0,0,0,`YXZ`).setFromQuaternion(m).y;let h=this.isDriftingState?this.driftGrip:this.normalGrip;if(this.currentGrip=At.damp(this.currentGrip,h,5.5,e),this.currentSpeed===0&&!n&&!r)this.body.velocity.x=At.damp(this.body.velocity.x,0,20,e),this.body.velocity.z=At.damp(this.body.velocity.z,0,20,e);else{let t=this.yaw+this.driftAngle*.3,n=Math.sin(t),r=Math.cos(t),i=n*this.currentSpeed,a=r*this.currentSpeed,o=1-(1-this.currentGrip)**(e*60);this.body.velocity.x=At.lerp(this.body.velocity.x,i,o),this.body.velocity.z=At.lerp(this.body.velocity.z,a,o)}this.mesh.position.copy(this.body.position);let g=new jt().setFromAxisAngle(new U(0,1,0),this.yaw+this.driftAngle);this.mesh.quaternion.copy(g);let _=(this.isDriftingState?this.driftDirection:this.currentSteer)*c*this.maxRoll*(this.isDriftingState?1.4:1),v=0;n?v=-.6:r&&(v=.6),s&&(v=.9);let y=v*c*this.maxPitch;this.chassisTiltGroup.rotation.z=At.damp(this.chassisTiltGroup.rotation.z,_,this.tiltLeanSpeed,e),this.chassisTiltGroup.rotation.x=At.damp(this.chassisTiltGroup.rotation.x,y,this.tiltLeanSpeed,e);let b=this.currentSteer*this.maxSteerAngle;this.isDriftingState&&(b=(this.currentSteer-this.driftDirection*.8)*this.maxSteerAngle),this.wheelPivots[0].rotation.y=b,this.wheelPivots[1].rotation.y=b;let x=this.currentSpeed*e/this.wheelRadius;this.wheelSpinners.forEach(e=>e.rotateX(x));let S=this.world.audio;if(S){S.isPlaying(`engine-loop`)||S.play(`engine-loop`);let t=Math.abs(this.currentSpeed)/this.maxSpeed,r=n?.2:0,i=.6+t*1.2+r;this.currentEnginePitch=At.damp(this.currentEnginePitch||.6,i,8,e),S.setRate(`engine-loop`,this.currentEnginePitch),S.setVolume(`engine-loop`,.2+t*.3),this.isDriftingState?S.isPlaying(`skid`)||S.play(`skid`):S.isPlaying(`skid`)&&S.stop(`skid`)}}onCollision(e,t){let n=this.world.audio;n&&n.playOneShot(`hit`,{cooldown:150})}getPosition(){return new U(this.body.position.x,this.body.position.y,this.body.position.z)}destroy(){let e=this.world.audio;e&&(e.stop(`engine-loop`),e.stop(`skid`)),super.destroy()}},wg=class extends gh{constructor(e,t={}){super(e);let{imageSrc:n,buttonImageSrc:r,position:i={x:0,y:0,z:0},size:a={width:4,height:4},triggerHeight:o=2,buttonLink:s=`https://example.com`}=t;this.buttonImageSrc=r,this.buttonLink=s;let c=new to().load(n);c.colorSpace=Ve;let l=new ni(new ua(a.width,a.height),new Sa({map:c,transparent:!0,depthWrite:!1,side:2}));l.rotation.x=-Math.PI/2,l.position.y=.02,l.receiveShadow=!0,this.mesh.add(l);let u=new Zu(new X(a.width/2,o/2,a.height/2));u.collisionResponse=!1;let d=new Q({mass:0,position:new X(i.x,i.y+o/2,i.z),isTrigger:!0});d.addShape(u),this.setPhysicsBody(d),this.popupElement=this._createPopupDOM()}_createPopupDOM(){let e=document.createElement(`div`);return e.className=`button-trigger`,e.style.position=`fixed`,e.style.bottom=`30px`,e.style.left=`50%`,e.style.transform=`translateX(-50%) translateY(20px)`,e.style.backgroundColor=`rgba(255, 255, 255, 0)`,e.style.backdropFilter=`blur(8px)`,e.style.display=`flex`,e.style.justifyContent=`center`,e.style.alignItems=`center`,e.style.zIndex=`1000`,e.style.opacity=`0`,e.style.pointerEvents=`none`,e.style.transition=`all 0.6s ease`,e.innerHTML=`
            ...
            >
                <img src="${this.buttonImageSrc}" alt="Button Icon" style="max-height: 80px; width: auto; object-fit: contain; pointer-events: none;" />
            </a>
        `,document.body.appendChild(e),e}showPopup(){this.popupElement&&(this.popupElement.style.opacity=`1`,this.popupElement.style.pointerEvents=`auto`,this.popupElement.style.transform=`translateX(-50%) translateY(0px)`)}hidePopup(){this.popupElement&&(this.popupElement.style.opacity=`0`,this.popupElement.style.pointerEvents=`none`,this.popupElement.style.transform=`translateX(-50%) translateY(20px)`)}onTriggerEnter(e){e&&e instanceof Cg&&this.showPopup()}onTriggerExit(e){e&&e instanceof Cg&&this.hidePopup()}destroy(){this.popupElement&&=(this.popupElement.remove(),null),super.destroy()}},Tg=new hh({orbitControls:!1}),Eg=!1,Dg=Sm(Tg.scene,Tg.physics.world);window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`p`&&(Eg=!Eg)});var Og=document.createElement(`div`);Og.style.position=`fixed`,Og.style.top=`0`,Og.style.left=`0`,Og.style.width=`100vw`,Og.style.height=`100vh`,Og.style.backgroundColor=`rgba(0, 0, 0, 0.75)`,Og.style.color=`#ffffff`,Og.style.display=`flex`,Og.style.flexDirection=`column`,Og.style.justifyContent=`center`,Og.style.alignItems=`center`,Og.style.fontFamily=`sans-serif`,Og.style.zIndex=`9999`,Og.innerText=`Loading...`,document.body.appendChild(Og),new Po,await Promise.all([Tg.audio.load(`engine-loop`,`sounds/engine-loop.mp3`,{loop:!0,volume:.1,positional:!0,refDistance:10}),Tg.audio.load(`skid`,`sounds/skid.mp3`,{loop:!0,volume:0,positional:!0,refDistance:5}),Tg.audio.load(`hit`,`sounds/hit.ogg`,{loop:!1,volume:.7}),Tg.audio.load(`bgm`,`sounds/bg-music.mp3`,{loop:!0,volume:.1}),Tg.audio.load(`horn`,`sounds/beep.mp3`,{loop:!1,volume:.5})]);var kg=new Cg(Tg,{x:0,y:2,z:-2}),Ag=2,jg=5,Mg=[{x:15,y:jg,z:10},{x:10,y:jg,z:10},{x:5,y:jg,z:10},{x:0,y:jg,z:10},{x:-5,y:jg,z:10},{x:-10,y:jg,z:10},{x:-15,y:jg,z:10},{x:-20,y:jg,z:5},{x:-20,y:jg,z:0},{x:20,y:jg,z:5},{x:20,y:jg,z:0}];for(let e=1;e<=Ag;e++)Mg.forEach(t=>{new _h(Tg,{x:t.x,y:jg*e,z:t.z})});new wg(Tg,{imageSrc:`images/github.png`,buttonImageSrc:`images/github-logo.png`,position:{x:10,y:0,z:-15},size:{width:10,height:10},buttonLink:`https://github.com/DANCH0U`}),new wg(Tg,{imageSrc:`images/linkedin.png`,buttonImageSrc:`images/linkedin-logo.png`,position:{x:-10,y:0,z:-15},size:{width:10,height:10},buttonLink:`https://www.linkedin.com/in/yahya-osman-ly/`});var Ng=0;function Pg(e){requestAnimationFrame(Pg);let t=(e-Ng)/1e3;Ng=e,Tg.camera.follow(kg.getPosition(),t),Tg.update(t),Eg&&Dg.update()}Og.innerHTML=`
    <h1 style="font-size: 2.2rem; margin-bottom: 24px; text-transform: uppercase; letter-spacing: 1px;">
    ...
    <div style="
        ...
        min-width: 260px;
    ">
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">W</span> <span>Accelerate</span></div>
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">S</span> <span>Reverse</span></div>
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">A / D</span> <span>Steering</span></div>
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">Shift</span> <span>Drift</span></div>
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">Space</span> <span>Brake</span></div>
        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold; color: #60a5fa;">H</span> <span>Beep</span></div>
    </div>
`;var Fg=!1;function Ig(){Fg||(Fg=!0,Og.remove(),Tg.audio.play(`bgm`),Pg(performance.now()),window.removeEventListener(`keydown`,Ig),window.removeEventListener(`pointerdown`,Ig))}window.addEventListener(`keydown`,Ig),window.addEventListener(`pointerdown`,Ig);